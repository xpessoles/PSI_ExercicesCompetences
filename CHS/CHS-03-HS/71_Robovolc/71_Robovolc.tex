...
\begin{marginfigure}
\centering
\includegraphics[width=\linewidth]{fig_23b.png}
...
La pièce grise est considérée comme encastrée sur le bâti 0. On pourra considérer, suivant votre choix, que la liaison entre cette pièce et le solide 6 est :
\begin{itemize} 
\item une liaison ponctuelle de normale $(S,\vy{P})$;
\item ou comme une liaison linéaire linéaire rectiligne $(S,\vy{P})$, direction $\vx{P}$.  
\end{itemize}
\begin{figure}[H]
\centering
