...
\begin{itemize}
\item $u(t) = e(t)+ Ri(t) +L \dfrac{\text{d}i(t)}{\text{d} t}$ et $e(t)=K\omega(t)$;
\item $c(t)=Ki(t)$ et $c(t)- f\omega(t)=J\dfrac{\text{d}\omega(t)}{\text{d} t}$.
\end{itemize}
\fi
...
\fi
\marginnote{Corrigé voir \ref{B2:04:51}.}
\fi