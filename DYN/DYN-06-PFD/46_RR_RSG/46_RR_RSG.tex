...
\exer{Mouvement RT -- RSG  $\star\star$ \label{C2:09:46}}
...
\index{PFD}
\index{Mécanisme à 2 rotations RSG}
\index{Culbuto}
\ifcorrection
\else
...
\question{Appliquer le théorème du moment dynamique à l'ensemble \textbf{2} au point $A$ en projection sur $\vect{k_0}$.}
\ifprof
\else
\fi
...
\marginnote{Corrigé voir \ref{C2:09:46}.}
