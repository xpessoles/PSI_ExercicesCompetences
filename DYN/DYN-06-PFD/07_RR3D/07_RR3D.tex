...
\exer{Mouvement RR 3D  $\star\star$ \label{C2:09:07}}
\setcounter{question}{0}\UPSTIcompetence[2]{B2-14}
\marginnote{\xpComp{DYN}{06}}%\UPSTIcompetence{C2-09}
...
\question{Dans le but d'obtenir les lois de mouvement, appliquer le théorème du moment dynamique au solide \textbf{2} au point $A$ en projection sur $\vect{i_1}$.}
...
\marginnote{Corrigé voir \ref{C2:09:07}.}
