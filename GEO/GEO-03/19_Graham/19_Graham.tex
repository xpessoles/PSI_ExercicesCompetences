...
\exer{Variateur de Graham\ifprof\else\footnote{Les éventuelles erreur de texte font partie intégrante de la difficulté :).}\fi $\star\star\star$ \label{GEO:03:C2:06:19}}

\marginnote{\textit{D'après ressources de Michel Huguet.}}
\setcounter{question}{0}
%\UPSTIcompetence[2]{B2-13}\UPSTIcompetence[2]{C2-05}
\marginnote{\xpComp{GEO}{03}}%\UPSTIcompetence[2]{C2-06}
\index{Compétence C2-05}\index{Compétence GEO-03}
