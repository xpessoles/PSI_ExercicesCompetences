...
\begin{figure}[!h]
\includegraphics[width=.6\linewidth]{94_02}
...
\marginnote{On considère l’ensemble $\Sigma$=\{{Turbine}, {Compresseur}, {Réducteur}, {Générateur}\}.}
...
Le rotor du moteur asynchrone de démarrage dont le moment d’inertie est $J_5=\SI{0,7}{kg.m^2}$ entraîne
 ...
 \begin{figure}[!h]
\includegraphics[width=.8\linewidth]{94_03}
...
\marginnote{Corrigé voir \ref{TEC:04:Jeq:94}.}
