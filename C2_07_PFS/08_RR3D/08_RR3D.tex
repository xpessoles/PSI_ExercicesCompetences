...
\exer{Mouvement RR 3D  $\star\star$ \label{C2:07:08}}
...
\question{Donner le couple à fournir pour chacun des moteurs pour maintenir le système à l'équilibre.}
\ifprof
\else
\fi
...
\else
\begin{flushright}
\footnotesize{Corrigé  voir \ref{C2:07:08}.}
\end{flushright}%
\fi